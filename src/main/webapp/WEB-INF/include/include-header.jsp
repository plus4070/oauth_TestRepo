	...
	<header id="header">
		<form>
			<div class="description">
				...
				<button type="button" class="btn btn-primary btn-lg" data-toggle="modal" data-target="#myModal" id="btn-login">Login</button>
				<button type="button" class="btn btn-default btn-search" onclick="search()">search</button>
				<div class="search-wrapper">
					<input type="text" class="form-control bar-search" id="searchBar" />
				</div>
			</div>
